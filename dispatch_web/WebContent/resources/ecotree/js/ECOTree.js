...
ECOTree = function (obj, elm) {
	this.config = {
		iMaxDepth : 100,
		iLevelSeparation : 40,//线的长度
		iSiblingSeparation : 40,//线的宽度
		...
		render : "AUTO",
		linkType : "M",
		linkColor : "black",//连线的颜色
		nodeColor : "#BFDCF7",//方框颜色
		nodeFill : ECOTree.SL_SINGLE,
		nodeBorderColor : "white",//边框线的颜色
		nodeSelColor : "#BFDCF7",
		...
		expandedImage : 'resources/ecotree/img/less.gif',
		collapsedImage : 'resources/ecotree/img/plus.gif',
		transImage : 'resources/ecotree/img/trans.gif'
	}
