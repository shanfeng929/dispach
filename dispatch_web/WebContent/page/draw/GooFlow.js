	...
	if(this.$editable){
	  this.$workArea.on("click",{inthis:this},function(e){
		...
		switch(type){// todo
			...
			case 'node': dispName ='存储过程节点';break;
			case 'chat': dispName ='远程脚本节点';break;
			case 'complex': dispName ='子服务节点';break;
		}
		This.addNode(This.$id+"_node_"+This.$max,{name:dispName,left:X,top:Y,type:This.$nowType});
		This.$max++;
	  });
	  //划线或改线时用的绑定
...
//			alert(This.$nodeData[id].type);
			var newValue = This.openNodeDialog(This.$nodeData[id]);
