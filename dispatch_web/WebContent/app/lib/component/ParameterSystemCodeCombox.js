...
Ext.define(projectName + '.lib.component.ParameterSystemCodeCombox', {
	extend : 'Ext.form.field.ComboBox',
	alias : 'widget.parameterSystemCodeCombox',
	requires : [ projectName + '.lib.Constants' ],
	editable : false,
	valueField : 'prmtrSysCd',
	displayField : 'prmtrSysNm',
	...
	initComponent : function() {
		...
		Ext.apply(me, {
			store : Ext.create('Ext.data.Store', {
				...
				proxy : {
					type : 'ajax',
					url : basePath + '/rwa/laboratory/parameterSystemCodeController/getParameterSystemCodeCombox',
