 ...
 * 新标准法树
 * **/
Ext.define(projectName + '.lib.component.NewStandardTreeComboBox', {
    extend: "Ext.form.field.Picker",
    requires: ['Ext.tree.Panel', projectName + '.lib.Constants'],
    alias: 'widget.newStandardTreeCombox',
    fieldLabel: '新标准法树',
    labelWidth: 60,
    height: 20,
    width: 250,
    ...
    initComponent: function () {
        var me = this;
        Ext.apply(me, {
            store: Ext.create(projectName + '.store.rwa.datas.NewStandardExponseStore',{
