Ext.define(projectName + '.lib.component.DateTimePicker', {
      extend: 'Ext.picker.Date',
      alias: 'widget.datetimepicker',
      todayText: '现在',
      timeLabel: '时间',
      requires: [projectName + '.lib.component.TimePickerField'],
      width : 200,
      ...
      onRender: function(container, position) {
          if(!this.timefield) {
              this.timefield = Ext.create(projectName + '.lib.component.TimePickerField', {
