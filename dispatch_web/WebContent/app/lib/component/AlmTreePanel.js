 ...
 * 
 */
Ext.define(projectName + '.lib.component.AlmTreePanel',{
	extend: 'Ext.tree.Panel',
	alias: 'widget.almTreePanel',
	...
	initComponent: function() {
		 ...
		 Ext.applyIf(me,{
			...
			dockedItems:  [{
	    	    ...
	    	    width:250,
	    	    items: [
	    	        {xtype: 'textfield',enableKeyEvents:true,id: me.id + '_tf_tree_queryContent', value:'',width:150,hidden:me.isHidden},
	    	        {xtype: 'button',id: me.id + '_btn_tree_QueryButton', iconCls:'search',text: '查询',hidden:me.isHidden}
	    	    ]
	    	}],
            viewConfig: {
            	stripeRows: true,
            ...
            listeners: {
            	boxready: function(treepanel, width, height, eOpts) {
            		...
            		/* 动态树加载时显示两次数据,其他不使用动态树的需自行新建lib文件
            		treepanel.store.on({
        				load: {
