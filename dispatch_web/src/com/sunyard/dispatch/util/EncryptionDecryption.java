...
public class EncryptionDecryption {
	...
	public static void main(String[] args) {
		try {
			EncryptionDecryption edDecryption = new EncryptionDecryption();
			String pwd = edDecryption.encrypt("shadfadfhadhfadjadsfja中文");
			System.out.println(pwd);
			String pwd_return  = edDecryption.decrypt(pwd);
